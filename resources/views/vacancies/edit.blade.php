...
<div class="p-8 space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h2 class="text-3xl font-semibold text-gray-900">Editar Vacante</h2>
            <p class="text-gray-500 mt-1">{{ $vacancy->title }}</p>
        </div>
    </div>
    ...
    <div class="max-w-2xl">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <form method="POST" action="{{ route('vacancies.update', $vacancy) }}" class="space-y-5">
                @csrf @method('PUT')
